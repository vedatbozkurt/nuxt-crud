 ...
 * @LastEditTime: 2021-08-29 20:02:00
-->
<template>
  <div class="container">
    <div class="w-screen h-screen flex justify-center items-center bg-gray-100">
      <form
        ...
        "
      >
        <div class="bg-red-500" v-if="errors.email">
          {{ errors.email[0] }}
        </div>
        <div class="bg-red-500" v-if="errors.password">
          {{ errors.password[0] }}
        </div>
        <div class="bg-red-500" v-if="errors.notapproved">
          {{ errors.notapproved[0] }}
        </div>
